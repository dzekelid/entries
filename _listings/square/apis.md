...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/entries/master/_listings/square/apis.md
...
- name: Square Connect - Provides comprehensive information for a single settlement,
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/entries/master/_listings/square/v1location-idsettlementssettlement-id-get-openapi.md
x-common:
- type: x-website
  url: http://square.com
- type: x-api-gallery
